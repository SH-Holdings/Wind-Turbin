      ...
      <InputGroup>
        ...
        <InputContainer>
          ...
          <Tooltip>
            <Icon />
            <TooltipText>
              The maximum lift coefficient achievable by the blades, relating to
              the lift produced at different angles of attack.
            </TooltipText>
          </Tooltip>
        </InputContainer>
      </InputGroup>
      ...
      <InputGroup>
        ...
        <InputContainer>
          ...
          <Tooltip>
            <Icon />
            <TooltipText>
              Indicates whether the brake is engaged when the gearbox is in high
              speed.
            </TooltipText>
          </Tooltip>
        </InputContainer>
